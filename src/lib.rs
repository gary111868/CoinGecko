...
#[derive(Debug)]
pub struct CoinGeckoAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CoinGeckoAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoinGeckoAPI processing");
    
    let mut processor = CoinGeckoAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoinGeckoAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoinGeckoAPIProcessor::new(false);
